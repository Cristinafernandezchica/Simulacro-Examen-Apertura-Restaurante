...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, status: 'offline', shippingCosts: null, email: null, phone: null, restaurantCategoryId: null }
